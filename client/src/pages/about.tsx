...
const AboutPage = () => {
  return (
    <div className="container mx-auto p-4">
      <Card>
        <CardHeader>
          <CardTitle>About Fuel Finder</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="mb-4">
            Fuel Finder is a powerful tool designed to help you save money on gas. Whether you're planning a road trip or just running errands around town, our app provides the tools you need to make informed decisions about your fuel consumption.
          </p>
